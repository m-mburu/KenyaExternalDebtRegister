...
mycolors <- c(
    "#386CB0", "#F0027F", "#BF5B17", "#1B9E77", "#D95F02",
    "#7570B3", "#66A61E", "#E6AB02", "#A6761D", "#2BB07FFF",
    "#C2DF23FF", "#38598CFF", "#482173FF", "#85D54AFF",
    "#1E9B8AFF", "#51C56AFF", "#FDE725FF", "#2D708EFF",
    "#433E85FF", "#25858EFF", "#440154FF", "#7FC97F",
