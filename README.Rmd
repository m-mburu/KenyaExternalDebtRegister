...
mycolors <-c("#386CB0", "#F0027F", "#BF5B17", "#1B9E77", "#D95F02", "#7570B3", 
             ...
             "#85D54AFF", "#1E9B8AFF", "#51C56AFF", "#FDE725FF", "#2D708EFF", 
...
ggplot(cretor_category_df, aes(x = reorder(president, -number), y = number, fill = creditor_category)) +
    geom_col() +
    #coord_flip() +
    scale_fill_manual(values =mycolors) +
    labs(title = "Number of loans by Creditor Category", x = "President", y = "Number of loans") +
    theme_minimal()
